...
// */
//
//package com.minlia.cloud.data.batis.autoconfiguration.handlers;
//
...
//public class DateTimeNumericTypeHandler extends BaseTypeHandler<DateTime> {
//
//    @Override
...
//        long time = parameter.getMillis();
//        ps.setLong(i, time);
//    }
//
//    private DateTime convertLongToDate(Long val) throws SQLException {
//        if (null == val) {
//            return null;
//        }
//
//        Date date=new Date(val);
////        return new DateTime.parse(date.toString());
